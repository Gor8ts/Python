...
CREATE DATABASE [Academy_6_Krotov]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Academy_6_Krotov', FILENAME = N'D:\SQLServer2016Media\MSSQL13.SQLEXPRESS\MSSQL\DATA\Academy_6_Krotov.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Academy_6_Krotov_log', FILENAME = N'D:\SQLServer2016Media\MSSQL13.SQLEXPRESS\MSSQL\DATA\Academy_6_Krotov_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
